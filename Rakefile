...
Jeweler::Tasks.new do |s|
  s.name = "gwright-awesome_nested_set"
  s.summary = "An awesome nested set implementation for Active Record"
  s.description = s.summary
  s.email = "gwright@at2002.com"
  s.homepage = "http://github.com/gwright/awesome_nested_set"
  s.authors = ["Gary Wright", "Brandon Keepers", "Daniel Morrison"]
